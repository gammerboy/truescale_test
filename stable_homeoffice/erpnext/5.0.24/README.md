...
This chart bootstraps an [erpnext](https://github.com/frappe/frappe_docker) deployment on a [Kubernetes](http://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
| `socketio.image.tag`                          | Image tag for socketio deployment                                                                                                                                                                                                                                                                                                                                                                        | `latest stable tag`                      |
